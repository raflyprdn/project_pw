			...
			<thead class="thead-dark">
				...
				<?php foreach ($result as $row) { ?>
					<tr>
						...
						<td><a href="<?= base_url('admin/lihathotel?id=' . $row->id) ?>" class="btn btn-danger">Hapus</a></td>
						<td><a href="<?= base_url('admin/edithotel?id=' . $row->id) ?>" class="btn btn-secondary">Edit</a></td>
						<td><a href="<?= base_url('admin/lihatkamar?id=' . $row->id) ?>" class="btn btn-info">Lihat Kamar</a></td>
					</tr>
				<?php } ?>
		</table>
		<?php
