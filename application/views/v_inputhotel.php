...
<body id="biodata">
	...
	<center><h3>Input Hotel</h3></center><br>
	<form method="POST" action="<?= base_url('admin/inputhotel')?>">
	...
	<table>
			...
			<tr>
				<td>Alamat</td><td><textarea name="alamat" class="form-control tbl"></textarea></td>
			</tr>
			<tr>
				<td>No Telepon</td><td><input type="text" name="notelp" class="form-control tbl"></td>
			</tr>
		</table>
		</div>
